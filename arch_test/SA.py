...
class UNetWithSAResnet50EncoderandSA(nn.Module):
    DEPTH = 6
    ...
    def forward(self, x, with_output_feature_map=False):
        ...
        for i, block in enumerate(self.down_blocks, 2):
            x = block(x)
            if i == (UNetWithSAResnet50EncoderandSA.DEPTH - 1):
                continue
...
def main():
    net = UNetWithSAResnet50EncoderandSA(num_classes=2)
    #print(net)
