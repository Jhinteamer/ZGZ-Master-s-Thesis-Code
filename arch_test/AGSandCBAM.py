...
class UNetWithSAResnet50EncoderandAGsCBAM(nn.Module):
    DEPTH = 6
    ...
    def __init__(self, n_classes=2, input_channels=3, deep_supervision = False, **kwargs):
        ...
        self.CBAM_5 = CBAM(in_planes=1024)
        ...
        self.CBAM_4 = CBAM(in_planes=512)
        ...
        self.CBAM_3 = CBAM(in_planes=256)
    ...
    def forward(self, x, with_output_feature_map=False):
        ...
        for i, block in enumerate(self.down_blocks, 2):
            x = block(x)
            if i == (UNetWithSAResnet50EncoderandAGsCBAM.DEPTH - 1):
                continue
...
def main():
    ...
    #net = CBAM(in_planes=256)
    net = UNetWithSAResnet50EncoderandAGsCBAM(num_classes=2)
    #print(net)
