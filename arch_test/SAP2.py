...
class UNetWithSAResnet50EncoderandSAP2(nn.Module):
    DEPTH = 6
    ...
    def forward(self, x, with_output_feature_map=False):
        ...
        for i, block in enumerate(self.down_blocks, 2):
            x = block(x)
            if i == (UNetWithSAResnet50EncoderandSAP2.DEPTH - 1):
                continue
        ...
        # 2048 up 1024 1024 + 1024 = 2048 up = 1024
        d5 = self.Up5(x)
        x4 = self.conv3x3_5(pre_pools[f"layer_4"])
        ...
        # 1024 up 512 512 + 512 = 1024 up = 512
        d4 = self.Up4(d5)
        x3 = self.conv3x3_4(pre_pools[f"layer_3"])
        ...
        # 512 up 256 256 + 256 = 512 up = 256
        d3 = self.Up3(d4)
        x2 = self.conv3x3_3(pre_pools[f"layer_2"])
        ...
        # 256 up 128 128 + 64 = 172 up = 128
        d2 = self.Up2(d3)
        x1 = self.conv3x3_2(pre_pools[f"layer_1"])
...
def main():
    net = UNetWithSAResnet50EncoderandSAP2(num_classes=2)
    #print(net)
    #print(net)
