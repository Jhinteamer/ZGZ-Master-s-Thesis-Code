...
class UNetWithSAResnet50EncoderandAGsSAORI(nn.Module):
    DEPTH = 6
    ...
    def __init__(self, n_classes=2, input_channels=3, deep_supervision = False, **kwargs):
        ...
        self.Att5 = Attention_block2(filters[3], filters[3], filters[2])
        ...
        self.Att4 = Attention_block2(filters[2], filters[2], filters[1])
        ...
        self.Att3 = Attention_block2(filters[1], filters[1], filters[0])
        ...
        self.Att2 = Attention_block2(128, filters[0], filters[0] // 2)
        # TODO
...
def main():
    net = UNetWithSAResnet50EncoderandAGsSAORI(num_classes=2)
    #print(net)
    input1 = torch.rand(1, 3, 224, 160)
    input2 = torch.rand(1, 3, 224, 160)
    pred = net(input1)
    print(pred.shape)
    #stat(net, (3, 160, 224))
